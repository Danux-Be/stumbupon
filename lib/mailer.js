...
async function sendEmailChangeEmail(to, username, token, lang = 'fr') {
  const baseUrl = process.env.BASE_URL || 'http://localhost:4000';
  const link = `${baseUrl}/verify-email-change/${token}`;

  const subjects = {
    fr: 'Confirmez votre nouvelle adresse email — StumbUpon.com',
    en: 'Confirm your new email address — StumbUpon.com',
    de: 'Bestätigen Sie Ihre neue E-Mail-Adresse — StumbUpon.com',
    es: 'Confirma tu nueva dirección de email — StumbUpon.com',
    nl: 'Bevestig uw nieuw e-mailadres — StumbUpon.com',
  };
  const bodies = {
    fr: `Bonjour ${username},\n\nTu as demandé à changer ton adresse email sur StumbUpon.com.\n\nCliquez sur ce lien pour confirmer ta nouvelle adresse (valable 1 heure) :\n${link}\n\nSi tu n'as pas fait cette demande, ignore cet email — ton adresse actuelle reste inchangée.\n\nÀ bientôt !`,
    en: `Hello ${username},\n\nYou requested an email address change on StumbUpon.com.\n\nClick this link to confirm your new address (valid for 1 hour):\n${link}\n\nIf you didn't request this, ignore this email — your current address remains unchanged.\n\nSee you soon!`,
    de: `Hallo ${username},\n\nDu hast eine Änderung deiner E-Mail-Adresse auf StumbUpon.com beantragt.\n\nKlicke auf diesen Link, um deine neue Adresse zu bestätigen (1 Stunde gültig):\n${link}\n\nWenn du dies nicht beantragt hast, ignoriere diese E-Mail.\n\nBis bald!`,
    es: `Hola ${username},\n\nHas solicitado cambiar tu dirección de email en StumbUpon.com.\n\nHaz clic en este enlace para confirmar tu nueva dirección (válido 1 hora):\n${link}\n\nSi no lo solicitaste, ignora este email.\n\n¡Hasta pronto!`,
    nl: `Hallo ${username},\n\nJe hebt een e-mailadreswijziging aangevraagd op StumbUpon.com.\n\nKlik op deze link om je nieuwe adres te bevestigen (geldig 1 uur):\n${link}\n\nAls je dit niet hebt aangevraagd, negeer dan deze e-mail.\n\nTot ziens!`,
  };
...
module.exports = { sendVerificationEmail, sendPasswordResetEmail, sendAdminAlert, sendDigestEmail, sendEmailChangeEmail };
